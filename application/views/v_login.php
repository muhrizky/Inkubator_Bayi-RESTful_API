...
<head>
  ...
  <title>Inkubator Controller</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/template/plugins/iCheck/square/green.css">
...
<div class="login-box">
  <div class="login-logo">
    <div class="callout callout-success">
                <h2><b>Sistem Pengendali Inkubator Bayi <b></h2>
  ...
  <div class="login-box-body">
    ...
    <a class="text-green" href="#">I forgot my password</a><br>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
